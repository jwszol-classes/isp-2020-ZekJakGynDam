...
def update_graph_live(n):
    ...
    fig.update_traces(marker=go.scattermapbox.Marker( size=5, color="rgb(100, 100, 100)", opacity=0.5),mode='markers')
    ...
    fig.update_mapboxes(accesstoken="ACCESS_TOKEN",#do ogarniecia z mapboxa
     zoom=5.8,
